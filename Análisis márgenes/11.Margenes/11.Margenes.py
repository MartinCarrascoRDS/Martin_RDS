...
archivo_ventas = f'/Users/martincarrasco/Desktop/Martín_Carrasco/Análisis márgenes/10.Eliminar_sin_costos/{fecha}/Paso10_{cuenta_meli}_{fecha}_sin_sku_faltantes.xlsx'
hoja_ventas = 'Sheet1'
...
df['Rango de precio'] = df['Ingresos por productos (CLP) Neto'].apply(clasificar_precio)
...
output_folder = f'/Users/martincarrasco/Desktop/Martín_Carrasco/Análisis márgenes/11.Margenes/{fecha}/'
