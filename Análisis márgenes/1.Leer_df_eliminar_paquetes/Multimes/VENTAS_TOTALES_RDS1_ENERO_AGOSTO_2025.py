"""
UNIÓN DE VENTAS TOTALES ENERO - AGOSTO 2025
"""
...
ventas_rds1_enero_agosto = pd.concat(dfs_meses, ignore_index=True)

print(f"\nDataFrame final: {ventas_rds1_enero_agosto.shape[0]} filas y {ventas_rds1_enero_agosto.shape[1]} columnas")

output_path = '/Users/martincarrasco/Desktop/Martín_Carrasco/Análisis márgenes/1.Leer_df_eliminar_paquetes/1.2.Detectar_estados/2025/VENTAS_TOTALES_RDS1_ENERO_AGOSTO_2025.xlsx'
ventas_rds1_enero_agosto.to_excel(output_path, index = False)