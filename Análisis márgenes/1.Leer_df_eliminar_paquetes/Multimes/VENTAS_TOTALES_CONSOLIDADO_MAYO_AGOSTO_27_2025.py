"""
UNIÓN DE VENTAS TOTALES MAYO - AGOSTO (HASTA 27-08) 2025
"""
...
ventas_mayo_agosto = pd.concat(dfs_meses, ignore_index=True)

print(f"\nDataFrame final: {ventas_mayo_agosto.shape[0]} filas y {ventas_mayo_agosto.shape[1]} columnas")

output_path = '/Users/martincarrasco/Desktop/Martín_Carrasco/Análisis márgenes/1.Leer_df_eliminar_paquetes/1.2.Detectar_estados/2025/VENTAS_TOTALES_CONSOLIDADO_MAYO_AGOSTO_27_2025.xlsx'
ventas_mayo_agosto.to_excel(output_path, index = False)