"""
UNIÓN DE VENTAS TOTALES ENERO 2024 - AGOSTO 2025
...
ventas_enero_2024_agosto_2025 = pd.concat(dfs_meses, ignore_index=True)

print(f"\nDataFrame final: {ventas_enero_2024_agosto_2025.shape[0]} filas y {ventas_enero_2024_agosto_2025.shape[1]} columnas")

output_path = '/Users/martincarrasco/Desktop/Martín_Carrasco/Análisis márgenes/1.Leer_df_eliminar_paquetes/Multimes/VENTAS_TOTALES_CONSOLIDADO_ENERO_2024_AGOSTO_2025.xlsx'
ventas_enero_2024_agosto_2025.to_excel(output_path, index = False)