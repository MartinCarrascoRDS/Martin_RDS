...
for mes in meses:
    ...
    archivos_mes = [
        f for f in glob.glob(os.path.join(carpeta_mes, "*omitido.xlsx"))
        if os.path.isfile(f)
    ]
...
output_path = '/Users/martincarrasco/Desktop/Martín_Carrasco/Análisis márgenes/3.Filtrar_estados/2025/VENTAS_CONSOLIDADO_ENERO_JULIO_2025_ESF.xlsx'
