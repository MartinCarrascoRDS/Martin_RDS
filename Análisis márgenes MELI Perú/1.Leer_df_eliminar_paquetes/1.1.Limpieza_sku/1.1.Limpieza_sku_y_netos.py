...
archivo_ventas = f'/Users/martincarrasco/Desktop/Martín_Carrasco/Análisis márgenes MELI Perú/1.Leer_df_eliminar_paquetes/{año}/{fecha}/Paso1_totales_{cuenta_meli}_{fecha}_listo.xlsx'
hoja_ventas = 'Sheet1'
...
df['Ingresos por venta (PEN)'] = df['Unidades'] * df['Precio unitario de venta de la publicación (PEN)']
df['Ingresos por venta (PEN) Neto'] = df['Ingresos por venta (PEN)'] / 1.18

# Guardar archivo
output_folder = f'/Users/martincarrasco/Desktop/Martín_Carrasco/Análisis márgenes MELI Perú/1.Leer_df_eliminar_paquetes/1.1.Limpieza_sku/{año}/{fecha}'
