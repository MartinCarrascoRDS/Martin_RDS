...
archivo_venta = '/Users/martincarrasco/Desktop/Martín_Carrasco/Testeo Reportes/Análisis márgenes/6.Separar_sku/Paso6_listo.xlsx'
hoja_venta = 'Sheet1'
...
df_costos_limpio = df_costos[['SKU', 'Costo']].copy()

duplicados_ventas = df_ventas.duplicated(subset=['# de venta'], keep=False)
...
duplicados_costos = df_costos_limpio.duplicated(subset=['SKU'], keep=False)
...
output_path = '/Users/martincarrasco/Desktop/Martín_Carrasco/Testeo Reportes/Análisis márgenes/7.Cruzar_costos_full/Paso7_listo.xlsx'
