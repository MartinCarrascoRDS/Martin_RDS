...
ventas_2024 = pd.read_excel(path_ventas, sheet_name = 'VENTAS SHOWROOM ', header = 4, usecols = 'B:Z')
...
final_2024.to_excel(f'{output_folder}/VENTAS ACUMULADAS VENTAS SHOWROOM {fecha_anterior}.xlsx', index = False)

# 2025

# Leer desde la columna B hasta la columna AB
ventas_2025 = pd.read_excel(path_ventas, sheet_name = 'VENTAS SHOWROOM ', header = 42, usecols = "B:AB")
...
# Guardar
final_2025.to_excel(f'{output_folder}/VENTAS ACUMULADAS VENTAS SHOWROOM {fecha}.xlsx', index=False)