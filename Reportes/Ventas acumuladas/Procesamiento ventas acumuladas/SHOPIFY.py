...
Script para el procesamiento de la base de datos de ventas acumuladas que se encuentra en la hoja VENTAS SHOPIFY
...
raw = pd.read_excel(path_ventas, sheet_name="SHOPIFY", header=None, dtype=str)
...
ventas_2025 = pd.read_excel(path_ventas, sheet_name = 'SHOPIFY', header = fila_inicio_2025, usecols = "B:AB")
...
# Guardar
output_folder = '/Users/martincarrasco/Desktop/Martín_Carrasco/Reportes/Ventas acumuladas/Procesamiento ventas acumuladas/VENTAS SHOPIFY'
final_2025.to_excel(f'{output_folder}/VENTAS ACUMULADAS VENTAS SHOPIFY {fecha_anterior}.xlsx', index = False)

# 2026
fila_inicio_2026 = filas_fecha[1]
ventas_2026 = pd.read_excel(path_ventas, sheet_name = 'SHOPIFY', header = fila_inicio_2026, usecols = "B:AB")
...
# Guardar
final_2026.to_excel(f'{output_folder}/VENTAS ACUMULADAS VENTAS SHOPIFY {fecha}.xlsx', index=False)